...
async def about_me(message):
    ...
    msg = (
        ...
        "<b>cracked By</b>: @hackerthamizhan007\n\n"
        ...
        "\n"
        f"<b>Latest  Changelog :- </b>\n"
         "Heroku support added by @hackerthamizhan007\n"
        "Improved the YTDL error reporting.\n"
        ...
        "/instadl removed because its too buggy for heroku\n"
    )
